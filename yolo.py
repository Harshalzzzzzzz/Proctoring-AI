...
if __name__ == '__main__':
	...
	if FLAGS.image_path:
		...
		while True:
			...
			cv.putText(frame, "Left pupil:  " + str(left_pupil), (5, 470), cv.FONT_HERSHEY_SIMPLEX, 0.5, (147, 58, 31), 1)
			cv.putText(frame, "Right pupil: " + str(right_pupil), (255, 470), cv.FONT_HERSHEY_SIMPLEX, 0.5, (147, 58, 31), 1)
